...
export default function Cart() {
    ...
    async function fetchCartProducts() {
        await axios.get("https://mern-project-ecom-5757.onrender.com/api/cart", {
    ...
    async function removeFromCart(productId){
        try{
            await axios.delete(`https://mern-project-ecom-5757.onrender.com/api/cart/remove/${productId}`,{
                headers:{Authorization:`Bearer ${user.token}`}
            })
            .then((res)=>{
