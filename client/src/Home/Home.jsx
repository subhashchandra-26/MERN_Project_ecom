...
export default function Home() {
  ...
  async function fetchProducts(){
    await axios.get("https://mern-project-ecom-5757.onrender.com/api/product")
      .then((res)=>{
        console.log(res)
  ...
  async function addCart(productId){
    ...
    try{
      await axios.post("https://mern-project-ecom-5757.onrender.com/api/cart/add",{productId},{
